...
class Config(object):
    ...
    ROOT_PROJECT_DIR = os.path.abspath(os.path.join(__file__, '..', '..'))    # zzx: it goes back to the hmr2.0-master directory
    ...
    SMPL_MODEL_PATH = os.path.join(ROOT_PROJECT_DIR, 'main', 'models', 'neutral_smpl_coco_regressor.pkl')

    # path to mean theta h5 file
    SMPL_MEAN_THETA_PATH = os.path.join(ROOT_PROJECT_DIR, 'main', 'models', 'neutral_smpl_mean_params.h5')

    # path to the custom regressors
    CUSTOM_REGRESSOR_PATH = os.path.join(ROOT_PROJECT_DIR, 'main', 'models', 'regressors')
